            ...
            <div>
                ...
                <form id="upload_form">
                    ...
                    <div>
                        ...
                        <div>
                        <label><input name="Fruit" type="radio" value="1"  checked />分类一 </label> 
						<label><input name="Fruit" type="radio" value="2" />分类二 </label> 
						<label><input name="Fruit" type="radio" value="3" />分类三 </label> 
						<label><input name="Fruit" type="radio" value="4" />分类四 </label> 
						<label><input name="Fruit" type="radio" value="5" />分类五 </label> 
                        </div>
					</div>
					<div>
                        <input type="button" value="立即投稿" id="tougao" />  <input type="button" id="fanhui" value="返回" />
                   	 </div>
					 </form>
