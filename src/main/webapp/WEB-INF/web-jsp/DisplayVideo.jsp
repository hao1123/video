...
http://shang.qq.com/open_webaio.html?sigt=6abe29a244eb227a65bc98c7bd8db390952bd95efbb3295f83d8383e3adbafd33663e0b1763171504a69aef06db7c246&sigu=53edec6635b8a65c6ebd2879cd09c64b5bf5425f269417462a92f949cec06d26fb69e1450ae26685&tuin=609673251"></a>
...
<%-- 					//得到标记为2的视频总数
					...
					var gong=<%=request.getAttribute("gong")%>;
					
			var dangqianye = 0;//页面加载时 默认当前页为 0
			//需要查询的标记 标记为1 2 3
			var State = '<%=request.getParameter("category")%>';
			//页面当前页
			var page = 1;
			var html = "";
					</script>
