...
<div style="background-color: #6C89B2;">
		<div style="float:left;margin-left: 5%;margin-top:5px">
			<a style="color: white;font-size:18px" href="logoone.sf">首页</a>
		</div>
	...
	<div style="margin-top:30px;margin-left:150px;margin-bottom:30px">
		<h1 style="font-size:150%;">分类一&nbsp&nbsp&nbsp&nbsp>>>&nbsp&nbsp&nbsp&nbsp<%=request.getAttribute("videoName") %></h1>
	</div>
...
<!-- 					<input
					...
					<input type="button" id="button" style="margin-left:20px;width:100px;height:50px" value="发表">
...
var slider = function(){
	...
	return init;
		...
		<span style="font-size:24px">滚动弹幕列表</span>
