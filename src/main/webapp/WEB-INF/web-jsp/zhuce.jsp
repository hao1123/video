					...
					<form id="form" action="register.sf" method="post"
						...
						<div id="form_submit" class="form_submit">
							<div class="fieldset">
								...
								<div class="field-group">
									<label class="required title">登录用户名</label> <span
										class="control-group" id="email_input">
										<div class="input_add_long_background">
								...
								<div class="field-group">
									...
									</span> <label class="tips">验证码:<span style="color: red"><%=request.getSession().getAttribute("yanzhengma") %></span></label>
								</div>
							</div>
						</div>
						...
						<div id="" class="" style="margin-left:18%;">
